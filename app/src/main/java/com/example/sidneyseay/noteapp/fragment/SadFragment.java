...
public class SadFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        UtilLog.d("Fragment", "SadOnCreate");
    }
    ...
    public void onStart() {
        super.onStart();
        UtilLog.d("Fragment,", "Sad:onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        UtilLog.d("Fragment,", "Sad:onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        UtilLog.d("Fragment,", "Sad:onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        UtilLog.d("Fragment,", "Sad:onStop");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        UtilLog.d("Fragment,", "Sad:onDestroy");
    }
}
