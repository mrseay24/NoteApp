...
public class GoodFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        UtilLog.d("Fragment", "GoodOnCreate");
    }
    ...
    public void onStart() {
        super.onStart();
        UtilLog.d("Fragment,", "Good:onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        UtilLog.d("Fragment,", "Good:onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        UtilLog.d("Fragment,", "Good:onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        UtilLog.d("Fragment,", "Good:onStop");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        UtilLog.d("Fragment,", "Good:onDestroy");
    }
}
